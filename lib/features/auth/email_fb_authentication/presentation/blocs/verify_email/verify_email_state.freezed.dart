...
class Initial implements VerifyEmailState {
  const Initial();
...
class Error implements VerifyEmailState {
  const Error();
...
class NotVerifiedYetMessage implements VerifyEmailState {
  const NotVerifiedYetMessage();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotVerifiedYetMessage);
}
...
@override
String toString() {
  return 'VerifyEmailState.notVerifiedYetMessage()';
}
