...
import 'package:mercado_v2/features/auth/new_fb_authentication/domain/usecases/resend_verification_email_usecase.dart';
...
class VerifyEmailBloc extends Bloc<VerifyEmailEvent, VerifyEmailState> {
  ...
  Future<void> _onResendVerificationEmail(VerifyEmailEvent event, Emitter<VerifyEmailState> emit) async {
