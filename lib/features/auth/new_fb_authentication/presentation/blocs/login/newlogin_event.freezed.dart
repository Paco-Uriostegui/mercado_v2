...
/// @nodoc
mixin _$NewLoginEvent {

 String get email; String get password;
/// Create a copy of NewLoginEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NewLoginEventCopyWith<NewLoginEvent> get copyWith => _$NewLoginEventCopyWithImpl<NewLoginEvent>(this as NewLoginEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NewLoginEvent&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password));
}
...
@override
String toString() {
  return 'NewLoginEvent(email: $email, password: $password)';
}
...
/// @nodoc
abstract mixin class $NewLoginEventCopyWith<$Res>  {
  factory $NewLoginEventCopyWith(NewLoginEvent value, $Res Function(NewLoginEvent) _then) = _$NewLoginEventCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$NewLoginEventCopyWithImpl<$Res>
    implements $NewLoginEventCopyWith<$Res> {
  _$NewLoginEventCopyWithImpl(this._self, this._then);

  final NewLoginEvent _self;
  final $Res Function(NewLoginEvent) _then;
...
/// Adds pattern-matching-related methods to [NewLoginEvent].
extension NewLoginEventPatterns on NewLoginEvent {
...
class NewLoginSubmitted implements NewLoginEvent {
...
@override
String toString() {
  return 'NewLoginEvent.loginSubmitted(email: $email, password: $password)';
}
...
/// @nodoc
abstract mixin class $NewLoginSubmittedCopyWith<$Res> implements $NewLoginEventCopyWith<$Res> {
