...
/// @nodoc
mixin _$NewLoginState implements DiagnosticableTreeMixin {
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'NewLoginState'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NewLoginState);
}
...
/// @nodoc
class $NewLoginStateCopyWith<$Res>  {
$NewLoginStateCopyWith(NewLoginState _, $Res Function(NewLoginState) __);
}


/// Adds pattern-matching-related methods to [NewLoginState].
extension NewLoginStatePatterns on NewLoginState {
...
class _Initial with DiagnosticableTreeMixin implements NewLoginState {
  const _Initial();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'NewLoginState.initial'))
    ;
}
...
class _Loading with DiagnosticableTreeMixin implements NewLoginState {
  const _Loading();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'NewLoginState.loading'))
    ;
}
...
class _Success with DiagnosticableTreeMixin implements NewLoginState {
  const _Success();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'NewLoginState.success'))
    ;
}
...
class _Error with DiagnosticableTreeMixin implements NewLoginState {
  const _Error(this.failure);
  

 final  Failure failure;

/// Create a copy of NewLoginState
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'NewLoginState.failure'))
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'NewLoginState.failure(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $NewLoginStateCopyWith<$Res> {
