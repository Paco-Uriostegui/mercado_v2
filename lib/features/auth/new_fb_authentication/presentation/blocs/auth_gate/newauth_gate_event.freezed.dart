...
part of 'newauth_gate_event.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NewAuthGateEvent);
}
...
/// @nodoc
class $NewAuthGateEventCopyWith<$Res>  {
$NewAuthGateEventCopyWith(NewAuthGateEvent _, $Res Function(NewAuthGateEvent) __);
}


/// Adds pattern-matching-related methods to [NewAuthGateEvent].
extension NewAuthGateEventPatterns on NewAuthGateEvent {
...
class InitStream implements NewAuthGateEvent {
  const InitStream();
...
@override
String toString() {
  return 'NewAuthGateEvent.initStream()';
}
