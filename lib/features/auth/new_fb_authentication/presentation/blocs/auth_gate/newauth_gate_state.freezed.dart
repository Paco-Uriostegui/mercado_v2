...
part of 'newauth_gate_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NewAuthGateState);
}
...
/// @nodoc
class $NewAuthGateStateCopyWith<$Res>  {
$NewAuthGateStateCopyWith(NewAuthGateState _, $Res Function(NewAuthGateState) __);
}


/// Adds pattern-matching-related methods to [NewAuthGateState].
extension NewAuthGateStatePatterns on NewAuthGateState {
...
class _Loading implements NewAuthGateState {
  const _Loading();
...
@override
String toString() {
  return 'NewAuthGateState.loading()';
}
...
class _GoToLogin implements NewAuthGateState {
  const _GoToLogin();
...
@override
String toString() {
  return 'NewAuthGateState.goToLogin()';
}
...
class _GoToVerifyEmail implements NewAuthGateState {
...
@override
String toString() {
  return 'NewAuthGateState.goToVerifyEmail()';
}
